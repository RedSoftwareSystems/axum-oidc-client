//! Token info route handler module.
//!
//! Provides a `/tokeninfo` route that requires authentication and displays
...
pub async fn tokeninfo(session: AuthSession) -> Html<String> {
    ...
    Html(format!(
        ...
        <body>
            <div class="container">
                <h1>🔒 Token Info</h1>
                <p>You have successfully accessed the token info page!</p>
